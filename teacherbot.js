    ...
    topics: {
      "Mathematics": {
        "Numbers and operations": {
          ...
          "Multiplication": { lesson: "Multiplication is repeated addition. When you multiply two numbers, you are adding one number to itself a certain number of times.", questions: [["What is 3 × 4?", ["7", "12", "15", "20"], 1], ["Which operation is the same as 5 + 5 + 5?", ["3 × 5", "5 × 3", "5 + 3", "3 + 5"], 0]], next: { subject: "Mathematics", topic: "Numbers and operations", subtopic: "Division" } },
          "Division": { lesson: "Division is the process of sharing or grouping things equally. When you divide, you are splitting a quantity into equal parts.", questions: [["What is 12 ÷ 3?", ["3", "4", "5", "6"], 1], ["Which operation is the inverse of multiplication?", ["Addition", "Subtraction", "Division", "Exponentiation"], 2]] },
          "Subtraction": { lesson: "Subtraction means to take a small amount from a larger amount.", image: "https://images.unsplash.com/photo-1497250681960-ef046c08a56e?auto=format&fit=crop&w=900&q=80", questions: [["How do you understand the concept of subtraction?", ["To take something out", "To add something in"], 0], ["What do most plants use to make food?", ["Sunlight", "Plastic", "Stones", "Toys"], 0]], next: { subject: "Science", topic: "Living things", subtopic: "Types of plants" } }
        },
