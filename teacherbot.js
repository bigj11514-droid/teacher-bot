...
const subjects = {
  ...
  { word: "slow", answer: "slowly" },
  { word: "quick", answer: "quickly" },
  { word: "light", answer: "lightly" },
  { word: "soft", answer: "softly" },
  { word: "happy", answer: "happily" },
  { word: "eager", answer: "eagerly" },
  { word: "swift", answer: "swiftly" },
  { word: "final", answer: "finally" },
  { word: "sad", answer: "sadly" },
  { word: "true", answer: "truly" },
  { word: "neat", answer: "neatly" },
  { word: "bright", answer: "brightly" },
  { question: "She .......... to school every morning.", options: ["go", "goes"], answer: "goes" },
  { question: "You .......... to granny's house every day.", options: ["walk", "walks"], answer: "walk" },
  { question: "It .......... a lot in June.", options: ["rain", "rains"], answer: "rains" },
  { question: "Musa .......... up at 6 o'clock.", options: ["get", "gets"], answer: "gets" },
  { question: "He always .......... at 9 o'clock.", options: ["sleep", "sleeps"], answer: "sleeps" },
  { question: "Baba .......... badminton every evening.", options: ["play", "plays"], answer: "plays" },
  { question: "We .......... our friends every day.", options: ["visit", "visits"], answer: "visit" },
  { question: "Father .......... very carefully.", options: ["drive", "drives"], answer: "drives" },
  { question: "Kwasi .......... T.V. for an hour every day.", options: ["watch", "watches"], answer: "watches" },
  { question: "I .......... for an hour daily.", options: ["walk", "walks"], answer: "walk" },
  { question: "The girl (is skipping, are skipping) with a rope.", answer: "is skipping" },
  { question: "I (am helping, is helping) my mother to bake a cake.", answer: "am helping" },
  { question: "The stars (is looking, are looking) brighter today.", answer: "are looking" },
  { question: "The boy (is whistling, are whistling).", answer: "is whistling" },
  { question: "The children (is building, are building) a sandcastle.", answer: "are building" },
  { question: "The students (is decorating, are decorating) the classroom.", answer: "are decorating" },
  { question: "Ebo (is watching, are watching) a cartoon.", answer: "is watching" },
  { question: "We (is driving, are driving) to Takoradi.", answer: "are driving" },
  { question: "The birds (is chirping, are chirping) on the tree.", answer: "are chirping" },
    { word: "Book", answer: "Many" },
    { word: "Porridge", answer: "Much" },
    { word: "Toy", answer: "Many" },
    { word: "Milk", answer: "Much" },
    { word: "Sand", answer: "Much" },
    { sentence: "Mansa loves to drink hot milk.", adjective: "hot" },
    { sentence: "Esinam bought two apples.", adjective: "two" },
    { sentence: "The black cat ran after the mouse", adjective: "black" },
    { sentence: "The clever dogs bark at night.", adjective: "clever" },
  { question: ".......... u a student?", answer: "Are" },
  { question: ".......... You help the poor?", answer: "Do" },
  { question: ".......... Kofi play with you?", answer: "Does" },
  { question: ".......... The children shout?", answer: "Do" },
  { question: ".......... The market open?", answer: "Is" },
  { sentence: "The dog is barking at the thief", subject: "The dog" },
  { sentence: "The boy is going to school", subject: "The boy" },
  { sentence: "The horse is eating grass.", subject: "The horse" },
  { sentence: "The cat is on the chair.", subject: "The cat" },
  { word: "Book", answer: "Many" },
  { word: "Porridge", answer: "Much" },
  { word: "Toy", answer: "Many" },
  { word: "Milk", answer: "Much" },
  { word: "Sand", answer: "Much" },
  { word: "Dress", answer: "Many" },
  { word: "Apple", answer: "Many" },
  { word: "Water", answer: "Much" },
  { word: "Car", answer: "Many" },
  { word: "Fruit", answer: "Much" }, // "Fruit" as uncountable/mass noun; "Many" if referring to specific kinds.
  { sentence: "Mansa has .......... cassettes at home, but she has not .......... time to listen to them.", answers: ["many", "much"] },
  { sentence: "There is so .......... food on the dinning table, but there are not .......... people to eat it .", answers: ["much", "many"] },
  { sentence: "How .......... toffees do you eat everyday ?", answers: ["many"] },
  { sentence: "She puts too .......... sugar in the tea.", answers: ["much"] },
    { question: "Who is Polly?", answer: "Polly is a little red hen." },
    { question: "What did Polly want to plant?", answer: "Polly wanted to plant some wheat." },
    { question: "Who refused to help Polly cut the wheat?", answer: "The dog refused to help Polly cut the wheat." },
    { question: "Mention the characters in the story?", answer: "Polly (the hen), the cat, the dog, and the cow." },
  { syllable: "La + ter", answer: "Later" },
  { syllable: "Im + port + ant", answer: "Important" },
  { syllable: "Ma + gin", answer: "Margin" },
  { syllable: "Let + ter", answer: "Letter" },
  { syllable: "Pa + rent", answer: "Parent" },
  { syllable: "De + ci + sion", answer: "Decision" },
  { syllable: "In + struc + tion", answer: "Instruction" },
  { syllable: "Com + plete", answer: "Complete" },
  { syllable: "Class + room", answer: "Classroom" },
  { syllable: "Sea + son", answer: "Season" },
  { word: "Jan..........ary", answer: "January", missingLetters: "u" },
  { word: "Fe.........ruary", answer: "February", missingLetters: "b" },
  { word: "M......rch", answer: "March", missingLetters: "a" },
  { word: "Ap.......il", answer: "April", missingLetters: "r" },
  { word: "M.............y", answer: "May", missingLetters: "a" },
  { word: "J........ne", answer: "June", missingLetters: "u" },
  { word: "J........ly", answer: "July", missingLetters: "u" },
  { word: "Au..........ust", answer: "August", missingLetters: "g" },
  { word: "Se.............tember", answer: "September", missingLetters: "p" },
  { word: "Oct............ber", answer: "October", missingLetters: "o" },
  { word: "Nove...........ber", answer: "November", missingLetters: "m" },
  { word: "De...............ember", answer: "December", missingLetters: "c" }
    ],
    middle: [
